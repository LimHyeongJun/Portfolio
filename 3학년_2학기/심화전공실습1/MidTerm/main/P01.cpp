...
//Draw an axis-aligned unit cube
void exam1() 
{
	setDiffuseColor(glm::vec3(1, 1, 1));	//Material
	drawCube();
...
//Scale the unit cube along the direction (1, 0, 0) with a scale factor s [0.05, 1.95]
void exam2() 
{
	float s = 1.0f + 0.95f * sin(frame * 0.1f / period);
	glScalef(s, 1, 1);
...
//Repeat (2) with the direction (1, 1, 0)
void exam3()
{
	float s = 1.0f + 0.95f * sin(frame * 0.1f / period);
	glm::vec3 direction(1, 1, 0);
...
//Repeat (3) wrt the pivot point(0.5, 0.5, 0.5)
void exam4()
{
	float s = 1.0f + 0.95f * sin(frame * 0.1f / period);
	glm::vec3 direction(1, 1, 0);
...
//Rotate the cube in (4) about z-axis
void exam5()
{
	float s = 1.0f + 0.95f * sin(frame * 0.1f / period);
	glm::vec3 direction(1, 1, 0);
...
//Repeat (5) wrt the pivot point (0.5, 0.5, 0.5)
void exam6()
{
	float s = 1.0f + 0.95f * sin(frame * 0.1f / period);
	glm::vec3 direction(1, 1, 0);

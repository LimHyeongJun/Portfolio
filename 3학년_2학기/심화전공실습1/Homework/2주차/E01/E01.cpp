...
void render(GLFWwindow* window) {
	...
	glBegin(GL_QUADS);
	{
		glColor3f(1, 0, 0); glVertex2f(-1.2, 0.8);
		glColor3f(0, 1, 0); glVertex2f(-0.5, 1.5);
		glColor3f(0, 0, 1); glVertex2f(0.5, 1.5);
		glColor3f(0, 0, 0); glVertex2f(1.2, 0.8);

		glColor3f(1, 0, 0); glVertex2f(1.2, -0.2);
		glColor3f(0, 1, 0); glVertex2f(0.5, -0.9);
		glColor3f(0, 0, 1); glVertex2f(-0.5, -0.9);
		glColor3f(0, 0, 0); glVertex2f(-1.2, -0.2);
	}
	glEnd();
}
